...
convert_csv_to_rds(Client_Data, "Client_Data.rds")
...
convert_csv_to_rds(Enrollment_Data, "Enrollment_Data.rds")
...
convert_csv_to_rds(Exit_Data, "Exit_Data.rds")
...
convert_csv_to_rds(Organization_Data, "Organization_Data.rds")
...
convert_csv_to_rds(Disabilities_Data, "Disabilities_Data.rds")
...
convert_csv_to_rds(IncomeBenefits_Data, "IncomeBenefits_Data.rds")
...
convert_csv_to_rds(Funder_Data, "Funder_Data.rds")
...
convert_csv_to_rds(CEParticipation_Data, "CEParticipation_Data.rds")
...
convert_csv_to_rds(HMISParticipation_Data, "HMISParticipation_Data.rds")
...
convert_csv_to_rds(Inventory_Data, "Inventory_Data.rds")
...
convert_csv_to_rds(Assessment_Data, "Assessment_Data.rds")
...
convert_csv_to_rds(Event_Data, "Event_Data.rds")
...
HealthDV_Data <- read_csv("HealthAndDV.csv", col_types = cols_only(
  ...
  filter(DataCollectionStage == "1")
convert_csv_to_rds(HealthDV_Data, "HealthDV_Data.rds")
